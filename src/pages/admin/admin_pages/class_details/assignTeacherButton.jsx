...
const AssignTeacherButton = ({ onAssignTeacher, class_data }) => {
    ...
    const updateTeacherLists = useCallback(() => {
        const assignedTeachers = class_data.teachers?.map((teacher) => teacher.id) || [];
    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold text-purple-600">Assign New Teachers</DialogTitle>
                </DialogHeader>

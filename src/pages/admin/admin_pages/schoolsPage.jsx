        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl w-full max-w-3xl mx-auto">
            <div className="relative">
                ...
                <div className="absolute -bottom-10 left-4">
                    <div className="w-28 h-28 rounded-full border-4 border-white overflow-hidden shadow-lg" style={{ boxShadow: '0 0 0 2px black' }}>
                        <img
                            src={logoImageUrl}
                            alt="School Logo"
            ...
            <div className="pt-12 px-6 pb-6 cursor-pointer" onClick={() => setShowDetails(!showDetails)}>
                <div className="flex justify-between items-center">
                    <h3 className="text-lg font-bold text-gray-800">{school.school_name}</h3>
                    <div className='flex'>
                        <Button
                            onClick={handleClick}
                ...
                <p className="text-gray-600 mt-2 text-sm">{school.email}, {school.address}</p>
                <div
                    className="mt-4 flex items-center  text-blue-500 hover:text-blue-700 cursor-pointer transition-colors duration-200"
                >
                    <span className="mr-2 font-semibold text-sm">{showDetails ? 'Hide Details' : 'Overview'}</span>

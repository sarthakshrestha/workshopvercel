      ...
      <div className="p-6">
        ...
        <div className="flex justify-start items-center mt-4">
          <span className="text-sm font-medium text-gray-800 flex items-center" style={{ letterSpacing: "1px" }}>
            ...
            Duration: <span className="text-blue-600 ml-1 font-bold">{course.course_duration}</span>
          </span>
        </div>
        <Dialog>
          ...
          <DialogContent className="bg-white rounded-lg p-6">
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-gray-800 mb-2">{course.course_name}</DialogTitle>
      ...
      <div className="flex-1 p-10 ml-[220px] xl:ml-[270px]">
        ...
        <div className="mb-8 flex justify-end">
          <Dialog>
            ...
            <DialogContent className="bg-white rounded-lg p-6">
              <DialogHeader>
                <DialogTitle className="text-2xl font-bold text-gray-800 mb-4">Add a New Course</DialogTitle>
              ...
              <DialogFooter className="mt-6">
                <Button onClick={handleAddCourse} className="bg-blue-900 hover:bg-blue-800 w-full text-white py-2 rounded-lg transition duration-300">
                  Submit
                </Button>
              </DialogFooter>
            </DialogContent>
